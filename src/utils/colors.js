...
export const PUERTO_TEJADA = {
  ...
  descripcion:
    "Puerto Tejada, ubicado en el norte del Cauca, es reconocido por su riqueza cultural, agrícola y el empuje de su gente. Esta aplicación es un homenaje a la educación y al futuro de nuestra región.",
...
const shadowCardWeb = "0px 2px 12px rgba(0,0,0,0.08)";
const shadowCardHighWeb = "0px 6px 20px rgba(0,0,0,0.12)";
const shadowRedWeb = "0px 4px 10px rgba(198,40,40,0.35)";
const shadowGreenWeb = "0px 4px 10px rgba(46,125,50,0.30)";

export const SHADOWS = {
  card: Platform.select({
    web: { boxShadow: shadowCardWeb },
    default: {
      shadowColor: "#000",
  ...
  cardHigh: Platform.select({
    web: { boxShadow: shadowCardHighWeb },
    default: {
      shadowColor: "#000",
  ...
  buttonGreen: Platform.select({
    web: { boxShadow: shadowGreenWeb },
    default: {
      shadowColor: "#2E7D32",
      shadowOffset: { width: 0, height: 4 },
      shadowOpacity: 0.3,
