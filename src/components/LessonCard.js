...
const InstitutionalStripe = () => (
  <View style={stripeStyles.container}>
    <View
      style={[stripeStyles.band, { backgroundColor: COLORS.puertoTejadaRed }]}
    />
    <View
      style={[stripeStyles.band, { backgroundColor: COLORS.puertoTejadaWhite }]}
    />
    <View
      style={[stripeStyles.band, { backgroundColor: COLORS.puertoTejadaGreen }]}
    />
  </View>
);
...
const LessonCard = React.memo(
  ({ lesson, onPress, isLandscape = false, isCompleted = false }) => {
    ...
    const progressColor =
      progress === 100 ? COLORS.puertoTejadaGreen : lesson.color;
    ...
    return (
      ...
      >
        ...
        {/* Ícono de la lección */}
        <View
          style={[styles.iconWrapper, { backgroundColor: lesson.color + "18" }]}
        >
          ...
          <View
            style={[styles.iconRing, { borderColor: lesson.color + "40" }]}
          />
        </View>
