...
const RequirementFlowScreen = ({ route, navigation }) => {
  ...
  const handleManualDownload = () => {
    ...
    sharePdf(
      html,
      "Manual del curso ProyectIA",
      "Manual PDF generado correctamente.",
      setManualStatus,
    );
  };
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.bodyText}>
            Este cuestionario recoge como entiendes y usas la IA actualmente. No
            se califica; sirve para personalizar tu proceso.
          </Text>
            ...
            <View key={item.question} style={styles.quizBlock}>
              ...
              <View style={styles.optionList}>
                {item.options.map((option) => {
                  const isSelected =
                    diagnosticAnswers[questionIndex] === option;
                  return (
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        handleDiagnosticSelect(questionIndex, option)
                      }
                    >
        ...
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>
            Caso practico de Puerto Tejada
          </Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.bodyText}>
            Descarga un manual con instrucciones de uso del curso y las lecturas
            resumidas de cada seccion.
          </Text>
          <TouchableOpacity
            style={styles.primaryButton}
          ...
          {!!manualStatus && (
            <Text style={styles.statusText}>{manualStatus}</Text>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.bodyText}>
            El certificado de este modulo solo se habilita cuando lo marcas como
            completado. Es un prototipo con nombre de prueba.
          </Text>
          ...
          {!isModuleCompleted ? (
            <TouchableOpacity
              style={styles.primaryButton}
              onPress={() => finishLesson(false)}
            >
              <MaterialIcons name="task-alt" size={20} color="#fff" />
              <Text style={styles.primaryButtonText}>
                Marcar modulo como completado
              </Text>
            </TouchableOpacity>
          ) : (
            <View style={styles.completedPill}>
              ...
              <Text style={styles.completedPillText}>
                Modulo completado. Certificado habilitado.
              </Text>
            </View>
          )}
          ...
          <TouchableOpacity
            style={[
              ...
              !isModuleCompleted && styles.disabledButton,
            ]}
          ...
          {!!certificateStatus && (
            <Text style={styles.statusText}>{certificateStatus}</Text>
          )}
        </View>

        <TouchableOpacity
          style={styles.secondaryButton}
          onPress={() => finishLesson(true)}
        >
