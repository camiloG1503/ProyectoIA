...
const LessonContentScreen = ({ route, navigation }) => {
    ...
    try {
      if (!mediaPermission?.granted) {
        ...
        if (!granted) {
          if (Platform.OS === "android") {
            Alert.alert(
              "Permiso denegado",
              "La app necesita acceso a la galería para guardar tu progreso.",
            );
          } else {
            Alert.alert(
              "Permiso denegado",
              "Necesitamos acceso a la galería para guardar la captura de pantalla.",
            );
          }
          return;
        }
      ...
      if (Platform.OS === "android") {
        ...
        Alert.alert(
          ...
          "La captura de esta lección se ha guardado en tu galería.",
        );
      }
    } catch (error) {
  ...
  const copyTipToClipboard = async () => {
    ...
    if (Platform.OS === "android") {
      ...
      Alert.alert(
        "📋 Consejo copiado",
        "Pégalo en tu IA favorita o compártelo.",
      );
    }
  };
        ...
        <View style={styles.header}>
          ...
          <View style={styles.interactiveBanner}>
            ...
            <Text style={styles.bannerText}>
              Agita el teléfono para un consejo IA
            </Text>
          </View>
        </View>
        ...
        <View style={styles.sensorCard}>
          ...
          <View style={styles.sensorValues}>
            <View style={styles.axisContainer}>
              <Text
                style={[styles.axisLabel, { color: COLORS.puertoTejadaRed }]}
              >
                X
              </Text>
            ...
            <View style={styles.axisContainer}>
              <Text
                style={[styles.axisLabel, { color: COLORS.puertoTejadaGreen }]}
              >
                Y
              </Text>
              <Text style={styles.axisValue}>
            ...
            <View style={styles.axisContainer}>
              <Text style={[styles.axisLabel, { color: COLORS.primaryDark }]}>
                Z
              </Text>
              <Text style={styles.axisValue}>
