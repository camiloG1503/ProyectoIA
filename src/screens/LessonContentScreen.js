            ...
            <View style={styles.modalOverlay}>
                ...
                >
                    <View style={styles.tipHeader}>
                        <MaterialIcons name="lightbulb" size={28} color={COLORS.puertoTejadaRed} />
                        <Text style={styles.tipHeaderText}>Consejo de Fidelina</Text>
                    </View>
                    <Text style={styles.tipText}>{currentTip}</Text>
                    <View style={styles.tipActions}>
                        <TouchableOpacity
                            style={[styles.tipButton, { backgroundColor: COLORS.puertoTejadaGreen }]}
            ...
            >
                ...
                <View style={styles.sensorCard}>
                    <View style={styles.sensorHeader}>
                        <MaterialIcons name="sensors" size={20} color={COLORS.puertoTejadaGreen} />
                        <Text style={styles.sensorTitle}>Acelerómetro en tiempo real</Text>
                    </View>
                    <View style={styles.sensorValues}>
                        <View style={styles.axisContainer}>
                            <Text style={[styles.axisLabel, { color: COLORS.puertoTejadaRed }]}>X</Text>
                            <Text style={styles.axisValue}>{accelerometerData.x.toFixed(3)}</Text>
                        </View>
                        <View style={styles.axisContainer}>
                            <Text style={[styles.axisLabel, { color: COLORS.puertoTejadaGreen }]}>Y</Text>
                            <Text style={styles.axisValue}>{accelerometerData.y.toFixed(3)}</Text>
                        </View>
                        <View style={styles.axisContainer}>
                            <Text style={[styles.axisLabel, { color: COLORS.primaryDark }]}>Z</Text>
                ...
                <View style={styles.section}>
                    ...
                    {lesson.topics.map((topic, index) => (
                        <View key={index} style={styles.topicItem}>
                            <MaterialIcons name="check-circle" size={18} color={COLORS.puertoTejadaGreen} style={{ marginRight: 8 }} />
...
const styles = StyleSheet.create({
    ...
    section: {
        ...
        marginBottom: 16,
        borderLeftWidth: 4,
        borderLeftColor: COLORS.puertoTejadaRed,
        ...SHADOWS.card,
    },
    sectionTitle: {
        fontSize: 18,
