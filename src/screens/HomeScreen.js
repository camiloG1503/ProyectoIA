...
import { isLessonUnlocked, loadProgress } from "../utils/storage";
        ...
        renderItem={({ item }) => (
          <View style={styles.lessonItem}>
            <LessonCard
              ...
              locked={!isLessonUnlocked(item.id, completedLessons)}
              lockedMessage="Completa el módulo anterior para desbloquear esta lección."
              onPress={
                isLessonUnlocked(item.id, completedLessons)
                  ? () =>
                      navigation.navigate(ROUTE_NAMES.MODULE_OVERVIEW, {
                        lesson: item,
                        previousScreen: "Home",
                      })
                  : () =>
          ...
          <View>
            ...
            <View style={styles.footer}>
              ...
              <View style={styles.footerContent}>
                <Text style={styles.footerTitle}>IA Learning</Text>
