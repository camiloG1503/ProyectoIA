        ...
        <Animated.View style={[styles.bodyContent, { opacity: fadeAnim }]}>
          ...
          <View style={styles.motivationCard}>
            ...
            <Text style={styles.motivationText}>
              La Inteligencia Artificial está cambiando el mundo. Cada lección
              que completas te acerca más a dominar esta tecnología y ser parte
              del futuro del Cauca.
            </Text>
            {completed > 0 && (
              <View style={styles.motivationChip}>
                ...
                <Text style={styles.motivationChipText}>
                  ¡Llevas {completed} lección{completed > 1 ? "es" : ""}{" "}
          ...
          <View style={styles.actionsSection}>
            ...
            >
              ...
              <View style={styles.actionTextWrap}>
                ...
                <Text style={styles.actionSub}>
                  Borra todo el avance del curso
                </Text>
              </View>
              <MaterialIcons
                name="chevron-right"
            ...
            >
              ...
              <View style={styles.actionTextWrap}>
                <Text
                  style={[styles.actionTitle, { color: COLORS.textSecondary }]}
                >
                  Cerrar sesión
                </Text>
                <Text style={styles.actionSub}>
