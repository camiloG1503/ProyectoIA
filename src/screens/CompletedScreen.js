...
const CompletedScreen = ({ route, navigation }) => {
  const { lesson, rewards } = route.params;
  const [refreshing, setRefreshing] = useState(false);
  const useNativeDriver = Platform.OS !== "web";

  const xp = rewards?.xp ?? 50 + lesson.id * 10;
  const badgeName =
    rewards?.badgeName ??
    {
      1: "Explorador de IA",
    ...
    "Insignia IA Learning";
  const phrase = rewards?.phrase ?? pickMotivationPhrase();
      ...
      >
        ...
        >
          ...
          <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
            ...
            <Text style={styles.congratsSubtitle}>Has terminado con éxito</Text>
          </Animated.View>
          ...
          {/* ═══════════════════════════════════════════════════════
                    ...
                    ═══════════════════════════════════════════════════════ */}
          <Animated.View
            style={[styles.lessonCard, { transform: [{ scale: scaleAnim }] }]}
          >
          ...
          {/* ═══════════════════════════════════════════════════════
                    ...
                    ═══════════════════════════════════════════════════════ */}
          <Animated.View
            style={[styles.rewardsCard, { transform: [{ scale: scaleAnim }] }]}
          >
            ...
            <Text style={styles.rewardPhrase}>{phrase}</Text>
          </Animated.View>
          ...
          {/* ═══════════════════════════════════════════════════════
                    ...
                    ═══════════════════════════════════════════════════════ */}
          <Animated.View
            style={[styles.actionsWrap, { transform: [{ scale: scaleAnim }] }]}
          >
            <TouchableOpacity
